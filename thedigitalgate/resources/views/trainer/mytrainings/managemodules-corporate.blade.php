                                ...
                                <div class="tab-content" id="main_form">
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step2">
                                        ...
                                        <h5 class="pt-2" data-toggle="collapse" href="#sessiontype" role="button"
                                            ...
                                            Session Type &nbsp; <i class="fa fa-caret-down" aria-hidden="true"></i>
                                        </h5>
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step4">
                                        ...
                                        <div class="form-group ">
                                            <button class="btn btn-secondary ">Upload Assessment Questioanare</button>
                                        </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <td>44</td>
                        <td>50</td>
                        <td>4.5  <a href="#" class="bluebtn btn-sm">Click Here</a></td>
