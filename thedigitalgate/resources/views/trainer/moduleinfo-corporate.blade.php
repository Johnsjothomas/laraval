...
<div class="container justify-content-center align-center pt-5 pb-5">
    ...
    <div class="pull-left">
    <h5 class="pt-3 mb-1">Module Title <a class="bluebtn pull-rigt btn-md" style="margin-left:100px;" href="#">Apply</a> </h5>
    ...
    <table class="table table-bordered">
            ...
            <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Introduction to communication and assessment tool</td>
                        <td>90</td>
