    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <a href="#" class="card-link">Active Modules</a>
                            ...
                            <form role="form" action="index.html" class="login-box">
                                <div class="tab-content" id="main_form">
                                    <div class="tab-pane active" role="tabpanel" id="step1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control">
                                                <option value="" disabled selected>select the Type of training
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control">
                                                <option value="" disabled selected>select the classsification
                                                </option>
                                        ...
                                        <div class="text-center">
                                            <div class="btn-group">
                                            <button type="button" class="bluebtn pl-4 pr-4 next-step active">Next</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step2">
                                        ...
                                        <div class="row">
                                            <div class="col-3"><label> Start*</label></div>
                                            <div class="col-3"><label> End*</label></div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                        <div class="btn-group">
                                        <button type="button" class="bluebtn pl-4 pr-4 prev-step mr-10">Back</button>
                                        <button type="button" class="bluebtn pl-4 pr-4 next-step ">Continue</button>
                                        </div>
                                        </div>
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step3">
                                        <div class="form-group">
                                            <h5>Trainee Handout Required</h5>
                                            <input class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-3"><label>Last Date of Submission*</label></div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-6 col-sm-3"><input type="date" class="form-control" placeholder="Month"></div>
                                            <div class="col-6 col-sm-3"><input type="text" class="form-control" placeholder="Day"></div>
                                        </div>
                                        <div class="form-group ">
                                            <button class="btn btn-secondary ">Upload a cover picture for your module</button>
                                        </div>
                                        <div class="">
                                        ...
                                        <div class="btn-group">
                                        <button type="button" class="bluebtn pl-4 pr-4 prev-step mr-10">Back</button>
                                        <a type="button" href="/talent/trainer/success" class="bluebtn pl-4 pr-4 next-step ">Save</a>
                                        </div>
                                        </div>
                                    </div>
                                </div>
