...
@include('trainer.submenu2')
    ...
    <div class="row">
    <div class="col-sm-1">
    <span class="whitebtn" style="border-radius: 5px; border: 1px solid #15284C;">Technical</span></div>
    <div class="col-sm-1 pb-5">
        <span class="whitebtn" style="border-radius: 5px; border: 1px solid #15284C;">Soft-skills</span></div>
    </div>
    ...
    <h2 class="pt-5 pb-3">Modules by category</h2>
            ...
            <div class="col-md-4 pt-3 pb-3">
                <div class="card">
                    <div class="card-header p-0">
                        ...
                        <div class="row">
                            <div class="col-10">
                        <h5 class="card-title pb-3">Modules by category</h3></div> </div>
                    </div>
            </div>
            </div>
            <div class="col-md-4 pt-3 pb-3">
            ...
            <div class="col-md-4 pt-3 pb-3">
                <div class="card">
                    <div class="card-header p-0">
                        ...
                        <div class="row">
                            <div class="col-10">
                        <h5 class="card-title pb-3">Modules by category</h5></div></div>
                    </div>
            </div>
            </div>
            <div class="col-md-4 pt-3 pb-3">
    ...
    <h2 class="pb-3 pt-5">Upcoming Modules</h2>
    <img class="img-fluid " style="width:100%" src = "{{ asset('talent/assets/img/myprofile.png') }}" />
    <h2 class="pb-3">
    Hands on Training-
    An effective way to learn
</h2>
<div class="p-1 pl-5 pr-5 right bluebtn">Apply</div>
    <div class="row">
    <div class="col-sm-1">
    <span class="whitebtn" style="border-radius: 5px; border: 1px solid #15284C;">Technical</span></div>
    <div class="col-sm-1 pb-5">
        <span class="whitebtn" style="border-radius: 5px; border: 1px solid #15284C;">Softskills</span></div>
    </div>
    <h2 class="pb-3">Current Modules</h2>
    ...
    <h2 class="pb-3">Upcoming Modules</h2>
...
<div class="p-5 justify-content-center align-center">
<div class="bluebtn p-1 pl-3 pr-3">See more modules by Talent Cloud</div>
    </div></div>
