        ...
        <div class="row">
            ...
            <div class="col-sm-6 p-5">
                ...
                <div class="container-fluid" style="width: 80%;">
                    <h2 class="pt-5">Update password </h2>
                    ...
                    <div class=" pl-0 pt-3">
                        <form method="POST" action="/update_password" class="submit-form">
            @csrf
                           ...
                           @error('password_confirmation')
                            ...
                            @enderror
                              ...
                              <!-- <input type="text" name="user" value="{{ session()->get('register_email') }}"/> -->
                              <!-- <input type="hidden" name="user" value="{{$_GET['id'] ?? ''}}"/> -->
                              <!-- <input type="hidden" name="user_type" value="{{strtolower($_GET['user_type'] ?? '')}}"/> -->
                            ...
                            <button type="submit" id="btnSubmit" class="btn btn-primary" style="background: #15284C;width: 100%;">Continue</button>
