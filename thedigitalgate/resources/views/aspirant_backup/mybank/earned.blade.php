...
@include('aspirant.submenu')
      <div class="container pt-5 pb-5" >
         ...
         <div class="row">
             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pb-5">
      ...
      <div class="row">
			    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border">
			      		<label class="pointer bold mediumfont1" >Earned</label> 
			      		<label class="pointer mediumfont1 bold pd15"> Spend</label>
			   </div>
      </div>
        <br><br>
      <div class="row">
             <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 pb-4">
      	         <div class="mediumfont bold"> Earned </div> 
      	      </div>
      </div>
