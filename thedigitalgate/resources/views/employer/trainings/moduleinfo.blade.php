...
<div class="container justify-content-center align-center pt-5 pb-5">
    ...
    <div class="bluebtn right" data-toggle="modal" data-target="#exampleModal">Apply</div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Terms and conductions</h5>
     ...
     <div class="form-check text-center">
        <input class="form-check-input position-static mr-2" type="checkbox" id="blankCheckbox" value="option1" aria-label="">I agree to terms & conditions  
      </div>
      </div>
