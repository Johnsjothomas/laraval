...
<div class="container justify-content-center align-center pt-5 p-0">
    ...
    <div class="row justify-content-center align-center">
       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
         <div  class="p-5 rounded" style="    background-color: white;">
         <div class="text-center">
          <div class="row">
          <div class="btn btn-success m-1 col-sm-12">
          Selected
          </div>
          <div class="btn btn-warning m-1 col">
          Pending
          </div>
          <div class="btn btn-danger m-1 col">
          Rejected
          </div>
          </div>
</div>
         ...
         <br>
         <div class="mediumfont1 pl-1">About me</div><br>
         <div class="normalfont2 bluefontcolor border-bottom ">Hey everyone, I’m Khaleel a UI, UX Designer currently interning at a company called Bottle. I also work as a freelance UI, UX designer. It’s been just 8 months since I started UI and UX designing. I am very Curious and Passionate when it comes to Design</div><br>
           <div class="mediumfont1 pl-1">Skills</div><br>
         ...
         <span class="normalfont3 m10" style="display: inline-block; color:#15284C;border-radius:5px;border: 1px solid #15284C;padding:2%">Advance prototypeing</span>
          ...
          <div class="border-bottom "><br>
             <div class="mediumfont1 pl-1">Additional information</div><br>
             <div class="normalfont1 p-1">D.O.B <span class="dob normalfont3 pl-3">17/11/20 </span></div>
             <div class="normalfont1 p-1">Gender <span class="dob normalfont3 pl-3">Male </span></div>
             <div class="normalfont1 p-1">Work Permit<span class="dob normalfont3 pl-3">Male </span></div>
             <div class="normalfont1 p-1">Marital status <span class="dob normalfont3 pl-3"> </span></div>
             <div class="normalfont1 p-1">languages <span class="dob normalfont3 pl-3"></span></div>
             <div class="normalfont1 p-1">Preferred location <span class="dob normalfont3 pl-3"> </span></div>
             <div class="normalfont1 p-1">Industries <span class="dob normalfont3 pl-3"></span></div>
          </div>
          <div>
            <br><br><br>
            <div class="text-center">
            <span class="normalfont3 m10" style="display: inline-block;color:#15284C;border-radius:5px;border: 1px solid #15284C;padding:2%">Download my Resume</span>
            </div><br><br><br>
          </div>
       </div>
       <div class="p-5 text-center">
       <div class="btn bluebtn2 m-1">
         Shortlist profile
        </div>
         <div class="btn bluebtn2 m-1">
         Schedule interview
       ...
       <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 pb-5" >
         <div class="rounded" style="    background-color: white;">
           <br><br>
        <div class="work p5 border-bottom">
         <div class="mediumfont1 pl-3">Work experience</div><br>
         <div class="row border-bottom">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
              <div class="">
                   <div class="normalfont1">Creative Director at Foxpin</div>
         ...
         <div class="row border-bottom">
            ...
            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
              <div class="">
                   <div class="normalfont1">Design Head at Circle chat</div> 
...
see more <span class="skybluefont">See more</span></div>
         ...
         <div class="row">
           ...
           <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 normalfont3">Show more</div>
          </div>
        </div>
        <div class="certificate p5 border-bottom">
         <div class="mediumfont1 pl-3">Certifications</div><br>
         <div class="row border-bottom">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                <center>
       ...
       <div class="Education p5 border-bottom">
               <div class="mediumfont1 pl-3">Education</div><br>
               <div class="row border-bottom">
                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                      <center>
                         <div class="normalfont3" style="background-color: darkblue;padding:2%;color:white;height:50px;width:50px;"></div>
      ...
      <div class="Projects p5 border-bottom">
               <div class="mediumfont1 pl-3">Projects</div><br>
               <div class="row">
                  
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0">
                      <div class="p-3">
                         <span class="normalfont3 m10 right" style="display: inline-block;color:#15284C;border-radius:5px;border: 1px solid #15284C;padding:1%">Download the project Document</span>
                           <div class="normalfont1">Pet park App Desing project</div>
                      <div class="normalfont2 bold"><span class="dob normalfont3">2021-2023</span></div><br>
                      <div class="normalfont1">About the App</div>
